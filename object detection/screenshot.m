...
[camera_name, camera_id, format]=cameraInfo(hardwareInfo); % Donaným bilgilerinden 
%kameranýn özelliklerinin ayýklanmasý
memoryInfo=imaqmem; % Bilgisayarýn bellek bilgisinin alýnmasý
imaqmem(memoryInfo.AvailPhys); % Kullanýma müsait bütün belleðin görüntü
%iþleme iþlemleri için kullanýlabilir hale getirilmesi
video = videoinput(camera_name, camera_id, format); % Kamera özelliklerine göre
%video objesinin oluþturulmasý
