...
if(~exist('video','var'))
    ...
    % Durdurma Butonu
    isRunning = 1;
    u=uicontrol('String','Stop','Callback','isRunning = 0; disp(''Hesaplamalar Durduruldu.'')',...         %stop butonunun görünümü ile ilgili yazý ve                                                                                                    %
    'ForegroundColor','w','BackgroundColor','r','Fontsize',14,'FontWeight','Demi','Position',[1 1 60 60]); %butonun büyüklük ve pozisyon ayarlarý 
